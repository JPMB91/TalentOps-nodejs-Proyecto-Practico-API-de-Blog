...
router.post(
  ...
  [
    ...
    body("autor")
      ...
      .withMessage("Autor debe tener entre 2 y 50 caracteres"),
    body("email")
      .optional()
      .isEmail()
      .normalizeEmail()
    ...
    body("contenido")
      ...
      .withMessage("Contenido debe tener entre 10 y 1000 caracteres"),
  ],
  validarErrores,
  createComment
);
...
router.put(
  ...
  [
    param("id")
      .isUUID()
      .withMessage("ID de comentario debe ser un UUID válido"),
    body("estado")
      .isIn(["pendiente", "aprobado", "rechazado"])
      .withMessage("Estado inválido"),
  ],
